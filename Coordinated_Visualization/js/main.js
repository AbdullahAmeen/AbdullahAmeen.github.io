...
var attrArray = ["Percent of Graduates Tested", "Average Composite ACT Score", "Percent Meeting English Benchmark",
...
var chartWidth = window.innerWidth * 0.434,
	chartHeight = 514,
	leftPadding = 25,
	rightPadding = 15,
	topBottomPadding =-3,
...
function setMap(){
	...
	var width = window.innerWidth * 0.524,
        height = 515;
...
function setGraticule(map, path){
	...
	var graticule = d3.geoGraticule()
        .step([15, 15]); //place graticule lines every 25 degrees of longitude and latitude
...
function updateChart(bars, n, colorScale){
    ...
    bars.attr("x", function(d, i){
        ...
        .attr("y", function(d, i){
            return yScale(parseFloat(d[expressed])) + topBottomPadding+1;
        })
        //color/recolor bars
        .style("fill", function(d){
