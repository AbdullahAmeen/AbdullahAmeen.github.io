...
var googleSat = L.tileLayer('http://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}',{
    ...
    attribution:'<span class="authordetails">Data Source:  <a href="https://www.google.com/maps" target=_blank>  <a href=" Google Map"> Google Map </a></a>| Mapped By: Abdullah Ameen <a href="mailto: abdullah.ameenn@gmail.com">Contact me</a> </span>' }).addTo(map);

    var masjid = new L.Icon({iconUrl:'MasjidsInWisconsin/img/Masjid.png',
    iconSize: [72, 55],
